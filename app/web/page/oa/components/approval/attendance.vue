<template>
  <div class="attendance">
    ...
    <div>
      <el-input
        v-required="params.attendance.departmentId"
        v-model="params.attendance.departmentId"
      ></el-input>
      <el-input
        v-required="params.attendance.timeSlot"
        v-model="params.attendance.timeSlot"
      ></el-input>
      <el-button v-required="submit">
        submit
      </el-button>
    </div>
  </div>
